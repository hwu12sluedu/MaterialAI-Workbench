            ...
            try:
                case = scan_case_folder(
                    ...
                    parameters={
                        ...
                        "yield_strength": float(cfg.yield_strength),
                        "tangent_modulus": float(cfg.tangent_modulus),
                        "displacement": float(cfg.displacement),
                        "applied_strain": float(cfg.displacement) / float(cfg.length),
                        "load_type": "displacement_tension",
